...
public class PayoutDataInit {
    ...
    // 배치 잡 실행
    // JobOperator를 사용하여 payoutCollectItemsAndCompletePayoutsJob 실행
    // 현재 날짜를 job parameter로 전달
    // collectPayoutItemsMore와 completePayoutsMore 메서드가 CHUNK_SIZE 만큼 데이터를 처리하도록 함
