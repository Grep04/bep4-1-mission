...
public class PayoutCollectItemsBatchJobConfig {
    private static final int CHUNK_SIZE = 10; // 10개씩 데이터 처리
    ...
    // 배치 스텝 정의
    // PayoutFacade의 collectPayoutItemsMore 메서드를 호출하여 데이터 처리
    // CHUNK_SIZE 만큼 처리하고, 더 이상 처리할 데이터가 없으면 종료
    @Bean
